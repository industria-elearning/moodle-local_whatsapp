...
/**
 * Data class for international phone number formats and country information.
 *
 * This class provides a comprehensive collection of phone number data for various countries,
 * including country codes, mobile number prefixes, and valid phone number lengths.
 * It is used by the WhatsApp plugin to validate and format phone numbers based on country-specific rules.
 *
...
class phone_data {
    /**
     * Comprehensive array of international phone number data.
     *
     * This method returns detailed information for each supported country, including:
     * - alpha2: Two-letter country code (ISO 3166-1)
     * - alpha3: Three-letter country code (ISO 3166-1)
     * - country_code: International dialing code
     * - country_name: Full country name
     * - mobile_begin_with: Array of prefixes that mobile numbers start with
     * - phone_number_lengths: Array of valid lengths for phone numbers in that country
     *
     * Reference:
     * @link https://moodle.org/plugins/profilefield_phone
     ...
     *
     * @param string $alpha2 Two-letter country code (ISO 3166-1). Example: 'US'
     * @return string
     */
     ...
     * @return string
     */
    public static function get_phone_with_code($alpha2, $phonenumber) {
        $countrycode = self::get_country_code($alpha2);
